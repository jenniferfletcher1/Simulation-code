...
3. Run all files starting with "2" (e.g. 2.1, 2.2, etc): contains all a simulation for each scenario & result is complete datasets for each method of handling the missing data as well as the simulated full data
