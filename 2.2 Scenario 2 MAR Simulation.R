##################################################################################################################
# Simulation Scenario 2: MAR
# approximately 14 hours to run
##################################################################################################################
...
for (i in 1:1000){
  ...
  generated_dataset_MAR <- generating_dataset_MAR(n = 5500,
                                                   ...
                                                   beta0_m_X1 = -0.35, beta1_m_X1 = 0.02,
                                                   beta0_m_X4 = 4.3, beta1_m_X4 = -1.1, beta2_m_X4 = -0.01)
...
write.csv(x = predictions_df_full, file = "predictions_df_full_MAR2.csv")
write.csv(x = predictions_df_CCA, file = "predictions_df_CCA_MAR2.csv")
write.csv(x = predictions_df_mode_mean, file = "predictions_df_mode_mean_MAR2.csv")
write.csv(x = predictions_df_mice_1, file = "predictions_df_mice_1_MAR2.csv")
write.csv(x = predictions_df_mice_10, file = "predictions_df_mice_10_MAR2.csv")
write.csv(x = predictions_df_mice_40 , file = "predictions_df_mice_40_MAR2.csv")
